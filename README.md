This was a project that allowed me to practice the skills I was learning in template engines (EJS), server-side programming (Node.js & Express), and working with NoSQL databases (MongoDB & Mongoose).
